        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>SSY: Sukanya Samruddhi Yojana</h1>
            </div>
                        ...
                        <div>
                          <div className="calculate-results-heading ">
                            ...
                            <div className="calculate-results">
                              <h4>Total maturity amount after 21 years </h4>
                              <p>1,12,000</p>
                            </div>
                            <div className="calculate-results">
                              <h4>
                                Total Interest you will earn in ____ years
                              </h4>
                              <p>1,01,000</p>
                            </div>
