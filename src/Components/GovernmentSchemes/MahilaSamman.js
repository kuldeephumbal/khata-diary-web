        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>MSSC: Mahila Samman Saving Certificate </h1>
            </div>
                      ...
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <div>
                          <div className="calculate-results-heading ">
                            ...
                            <div className="calculate-results">
                              <h4>Total Interest earned in 2 years</h4>
                              <p>1,01,000</p>
                            </div>
                            <div className="calculate-results mb-0">
                              <h4>Lumpsum Deposit Amount</h4>
                              <p>12,000</p>
                            </div>
                          </div>
                          <div className="tenure-details">
                            <p>
                              At the end of your tenure of 2 years you will get
                              Total Amount of Rs. 20.00
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="accordion" id="accordionExample">
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          >
                            How does Mahila Samman Saving Certificate works ?
                          </button>
                        </h2>
                        <div
                          id="collapseTwo"
