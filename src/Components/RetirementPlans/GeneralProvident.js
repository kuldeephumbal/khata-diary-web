        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>GPF: General Provident Fund </h1>
            </div>
                      ...
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <>
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">
                              Current balance in your GPF account
                            </label>
                            <input
                              type="number"
                              id="interestRate"
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">
                              Increase in Monthly Deposit Every Year
                            </label>
                            <div className="loan-tenure">
                      ...
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <div>
                          <div className="calculate-results-heading ">
                            ...
                            <div className="calculate-results">
                              <h4>Your Total Investment Amount</h4>
                              <p>1,01,000</p>
                            </div>
                          ...
                          <div className="tenure-details">
                            <p>
                              ...
                              calculator. Future Annual Interest rate may change
                              by government so, Actual Returns may vary. It
                    ...
                    <div className="table-monthly" id="yearly">
                      <table className="table table-bordered text-center">
                        <thead>
                          <tr>
                            <th>Years</th>
                            <th>Your Investment Amount (Rs)</th>
                    ...
                    <div class="accordion" id="accordionExample">
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          >
                            How does General Provident Fund ?
                          </button>
                        </h2>
                        <div
                          id="collapseTwo"
...
export default GeneralProvident;
