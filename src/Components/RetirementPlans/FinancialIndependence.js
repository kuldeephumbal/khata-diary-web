        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>FIRE: Financial Independence & Retire Early </h1>
            </div>
                    ...
                    <div className="row">
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <>
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate1">
                              Monthly Expenses at Current Cost
                            </label>
                            <input
                              type="number"
                              id="interestRate1"
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate1">
                              Any Reduction in Expenses post Retirement <Info />
                            </label>
                            <input
                              type="number"
                              id="interestRate1"
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate1">
                              Existing/Current Investment <Info />
                            </label>
                            <input
                              type="number"
                              id="interestRate1"
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate1">
                              Future Annual Inflation Rate (Usually 4 to 10%){" "}
                              <Info />
                            </label>
                            <input
                              type="number"
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate1">
                              Annual Return on Investment Before Retirement
                              <Info />
                            </label>
                            <input
                              type="number"
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate1">
                              Annual Return on Investment Post Retirement
                              <Info />
                            </label>
                            <input
                              type="number"
                        ...
                        <div>
                          <div className="calculate-results-heading ">
                            ...
                            <div className="calculate-results">
                              <h4>
                                Monthly Required Amount After retirement age of
                                7 years
                              </h4>
                              <p>1,12,000</p>
                            </div>
                            <div className="calculate-results">
                              <h4>
                                Total corpus required on Retirement day to
                                Maintain current living standard with future
                                Inflation of 2% Rate after retirement age of 7
                                Years
                              </h4>
                              <p>1,01,000</p>
                            </div>
                            <div className="calculate-results mb-0">
                              <h4>
                                To Achieve this goal you need to Invest Monthly
                                amount of Rs. 200{" "}
                              </h4>
                              <p>12,000</p>
                            </div>
                    ...
                    <div class="accordion" id="accordionExample">
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          >
                            How does Financial Independence & Retire Early?
                          </button>
                        </h2>
                        <div
                          id="collapseTwo"
