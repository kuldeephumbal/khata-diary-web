...
import { Bell, Trash2, Search, BellRing, Dice1 } from "lucide-react";
                ...
                {activeTab === "notes-home" && (
                  <div className="tab-pane fade show active">
                    <div>
                      ...
                      <div className="expense-added-notes mb-3  ">
                        <input
                          type="text"
                        ...
                        />
                        <div className="search-added-notes">
                          <Search />
                        </div>
                        <div>
                          <button type="button" className="btn d-none"></button>
                          <div
                              ...
                              <div className="modal-content">
                                <div className="modal-body">
                                  <div className="Customer-modal">
                                    ...
                                    <div className="title-center">
                                      <button className="title-customer">
                                        <div className="customer-round">
                                          <p>Ab</p>
                                        </div>
                                        <div>
                                    ...
                                    <div className="title-center">
                                      <button className="title-customer mb-0">
                                        <div className="customer-round">
                                          <p>CR</p>
                                        </div>
                                        <div>
                                ...
                                <div className="modal-footer-added d-flex justify-content-center">
                                  <button
                                    type="button"
                                    className="btn btn-cancel w-75 d-f"
