...
function ExpenseEmpty() {
  ...
  const [pieChartData, setPieChartData] = useState([]); // New state for pie_chart_data
  ...
  const [editBudgetType, setEditBudgetType] = useState("Budget2"); // Default to Monthly
  ...
  const fetchExistingBudgets = async () => {
    ...
    try {
      ...
      setPieChartData(data.pie_chart_data || []); // Store pie_chart_data
            ...
            <div className="tab-content" id="pills-tabContent">
              ...
              >
                <div className="expense-empty-bg">
                  ...
                  <div className="expense-empty-select">
                    <select name="budget" id="budget">
                      ...
                      {existingBudgets.map((budget) =>
                        Array.isArray(budget.budget_details) ? (
                          budget.budget_details.map((detail, index) => (
                            <option key={`${budget.id}-${index}`} value={detail.category_id}>
                              {detail.category_name || "Unknown"}
                            </option>
                          ))
                        ) : null
                      )}
                  ...
                  <div className="expense-empty-select">
                    <textarea placeholder="Add Expense Details (optional)"></textarea>
                  </div>
                  <div className="expense-empty-amo">
                  ...
                  <div className="file-input">
                    ...
                    <label className="file-input__label" htmlFor="file-input">
                      ...
                      >
                        <path
                          d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v4h4v2h-4v4h-2v-4H7v-2h4V7z"
                          fill="#28303F"
                        />
                      </svg>
