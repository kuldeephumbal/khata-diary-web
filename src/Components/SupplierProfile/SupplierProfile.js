        ...
        <div className="row">
          <div className="col-12 py-20">
            <div className="expense-title">
              ...
              <Link to="/">
                Supplier Profile <i className="fa-solid fa-chevron-right"></i>
              </Link>
              <span>
              ...
              <div className="index-pill">
                ...
                >
                  <div className="user-name">
                    <MessageSquareText />
                    <div>
                      <h3>Supplierr Message Setting </h3>
                    </div>
                  </div>
                  <div>
                    <ChevronRight />
                    ...
                    <div className="modal-content">
                      <div className="modal-body">
                        ...
                        <div className="change-supplier-profile">
                          <h4>Change Adam. S to Customer ?</h4>
                        </div>
          ...
          <div className="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 py-40 pt-0">
            <div className="index-pill">
              ...
              {activeSection === "customerSettings" && (
                <>
                  <div className="customer-profile-name">
                    <h4>Supplier Message Setting </h4>
                  </div>
                  <div className="form-switch-flex">
                    <div className="user-name">
                      <MessageSquareText />
                      <div>
                        <h3>Supplier Message Setting </h3>
