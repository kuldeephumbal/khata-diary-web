...
import staff_management from "../../images/staff-management-bg.svg";
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 py-40 pt-0">
          <div className="staff-management-bg expense-empty-bg">
            <div className="staff-management-img">
              <img src={staff_management} className="img-fluid" alt="" />
            </div>
            <div className="staff-works">
              <h4>How It Works</h4>
              <h5>Add staff, Business partners or Family members</h5>
              <p>
                <Goal size={18} /> Give access to partners & staff on their
                phone number
              </p>
              <p>
                <CircleCheckBig size={18} /> Give access to partners & staff on
                their phone number
              </p>
            </div>
            <div className="add-staff-btn">
              <Link to="/StaffTwo" className="add-staff">
        ...
        <div className="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 py-40 pt-0">
          <div className="staff-col-bg">
            <div className="staff-col-flex">
