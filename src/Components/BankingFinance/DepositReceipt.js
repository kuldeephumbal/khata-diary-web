        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>FD : Cumulative Special Term Deposit Receipt </h1>
            </div>
                        ...
                        <div>
                          <div className="calculate-results-heading">
                            ...
                            <div className="calculate-results mb-0">
                              <h4>Effective Annual Interest Rate</h4>
                              <p>12,000</p>
                            </div>
                          </div>
                    ...
                    <div class="accordion" id="accordionExample">
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          >
                            What is Cumulative Special Term Deposit Receipt ?
                          </button>
                        </h2>
                        <div
                          id="collapseOne"
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          >
                            How does Cumulative Special Term Deposit Receipt
                            works?
                          </button>
                        </h2>
                        <div
