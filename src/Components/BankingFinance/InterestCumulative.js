                      ...
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <div>
                          ...
                          <div className="tenure-details">
                            <p>
                              At the end of your tenure of _____ ( Months /
                              Years ) you will get total amount_____( D + 1 )
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="accordion-item">
                        ...
                        >
                          <div class="accordion-body">
                            ...
                            elit. Necessitatibus, porro. Error adipisci
                            distinctio voluptatibus consectetur nisi nam
                            expedita laboriosam dolore?124
                          </div>
                        </div>
                      </div>
                    </div>
...
export default InterestCumulative;
