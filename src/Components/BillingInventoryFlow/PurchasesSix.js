                ...
                {activeTab === "purchases" && (
                  <>
                    <div className="receipt-main">
                      <h4>Receipt Number 1</h4>
                      <h5>Date: 23 Nov 24</h5>
                    </div>
                    ...
                    <div class="file-input-type">
                      <input
                        ...
                        name="file-input"
                        id="file-input"
                        class="file-input__input-type"
                      />
                      <label class="file-input__label-type" for="file-input">
                        <span>
                          Enter detailed (Items bills no quantity ect)
                        </span>
                        <Camera />
                      </label>
                    </div>
                    <div>
                      <div className="accordion-eight">
                        <div className="accordion__item-one">
                          <div
                          ...
                          >
                            <div>
                              ...
                              <p>
                                Choose invoice to settle against this payment in
                              </p>
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div className="pending-invoice-main">
                              <div className="pending-invoice">
                                ...
                                <div className="pending-dec">
                                  <h3>#2</h3>
                                  <p>13 Dec 24</p>
                                </div>
                              </div>
                              <div className="pending-rupee">
                                <h4>₹ 1,000</h4>
                                <h5>₹ 1,000 Pending</h5>
                              </div>
                            </div>
