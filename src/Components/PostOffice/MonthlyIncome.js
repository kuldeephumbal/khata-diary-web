        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>MIS: Monthly Income Scheme </h1>
            </div>
                      ...
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <>
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">Deposit amount</label>
                            <input
                              type="number"
                              id="interestRate"
                              placeholder=" Rs ."
                        ...
                        <div>
                          <div className="calculate-results-heading ">
                            ...
                            <div className="calculate-results">
                              <h4>You will get Monthly Interest Amount Rs</h4>
                              <p>1,12,000</p>
                            </div>
                            <div className="calculate-results">
                              <h4>Total Interest You will receive</h4>
                              <p>1,01,000</p>
                            </div>
                            <div className="calculate-results mb-0">
                              <h4>Total Amount (D+1) You will receive</h4>
                              <p>12,000</p>
                            </div>
                          </div>
                          <div className="tenure-details">
                            <p>
                              Note: At the end of your term of_______(Years) you
                              will get back your deposit amount of Rs_______
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <table className="table table-bordered text-center">
                        <thead>
                          <tr>
                            ...
                            <th>Cumulative Interest amount (Rs) </th>
