        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>SWP - Systematic Withdrawal plan </h1>
            </div>
                        ...
                        <>
                          ...
                          <div className="emi-input-group">
                            ...
                            <div className="loan-tenure">
                              ...
                              <select name="emi" placeholder="Rs." id="emi">
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">
                              Step up your withdrawal every year by
                            </label>
                            <div className="loan-tenure">
                              <input
                                type="number"
                              ...
                              <select name="emi" id="emi">
                                <option value="monthly">Rupees</option>
                                <option value="saab">Saab</option>
                                <option value="mercedes">Mercedes</option>
                                <option value="audi">Audi</option>
                              </select>
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">Withdrawn Term</label>
                            <div className="loan-tenure">
                              <input
                                type="number"
                                placeholder="Rs."
                        ...
                        <div>
                          <div className="calculate-results-heading ">
                            ...
                            <div className="calculate-results">
                              <h4>Total withdrawal amount (Months/Years) </h4>
                              <p>1,12,000</p>
                            </div>
                            <div className="calculate-results">
                              <h4>Total Return on investment</h4>
                              <p>1,01,000</p>
                            </div>
                            <div className="calculate-results mb-0">
                              <h4>Final Balance in Account after </h4>
                              <p>12,000</p>
                            </div>
                          </div>
                          <div className="tenure-details">
                            <p>
                              ...
                              Months/Years) you will get total balance amount of
                              Rs ______You can either continue to withdraw it
                              monthly or lump sum or remain invested
                            </p>
                            <p>
                              Note: As SWP Returns are purely based on market
                              conditions, so SWP returns are not guaranteed and
...
export default SystematicWithdrawal;
