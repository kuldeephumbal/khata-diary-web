        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>ELSS-Equity Linked Saving Scheme </h1>
            </div>
                    ...
                    <div className="row">
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <>
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">
                              Step up your investment every year by
                            </label>
                            <div className="loan-tenure">
                              <input
                                type="number"
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">
                              Deposit term ‘(Lock in period for ELSS is 03
                              years)’
                            </label>
                            <div className="loan-tenure">
                              <input
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">
                              Expected annual rate of returns in percentage
                            </label>
                            <input
                              type="number"
                              placeholder=" (%)."
                        ...
                        <div>
                          ...
                          <div className="tenure-details">
                            <p>
                              ...
                              Months/Years) you will get total amount of Rs
                              ______
                            </p>
                            <p>
                    ...
                    <div class="accordion" id="accordionExample">
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          >
                            What is Equity Linked Saving Schemet ?
                          </button>
                        </h2>
                        <div
                          id="collapseOne"
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          ...
                          >
                            How does Equity Linked Saving Scheme?
                          </button>
                        </h2>
                        <div
                          id="collapseTwo"
