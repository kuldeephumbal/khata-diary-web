        ...
        <div className="row">
          <div className="py-40">
            <div className="emi-heading">
              <h1>SIP - Systemic Investment Plan </h1>
            </div>
                    ...
                    <div className="row">
                      <div className="col-12 col-xl-6 col-md-6 col-sm-6 col-12">
                        <>
                          ...
                          <div className="emi-input-group">
                            <label htmlFor="interestRate">
                              Expected annual rate of return in percentage
                            </label>
                            <input
                              type="number"
                              placeholder=" (%)."
...
export default SystemicInvestment;
